...
export const EditPage = () => {
    ...
    const handleUpdate = () => {
        ...
        console.log('Updating problem:', { id, title, slug, content, difficulty, tags, timeLimit, memoryLimit });
    ...
    return (
        <ModeratorLayout>
            <header className="h-16 border-b border-[#1e293b] bg-slate-900/50 backdrop-blur flex justify-between items-center px-8 z-10 sticky top-0 shrink-0">
                ...
                >
                    <i className="ph-bold ph-floppy-disk"></i> Lưu Thay Đổi
                </button>
            </header>
