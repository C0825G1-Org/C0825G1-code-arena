...
export const AdminUserListPage: React.FC = () => {
    ...
    return (
        <>
        <div className="flex h-screen overflow-hidden bg-slate-900 selection:bg-red-500/30 font-sans">

            {/* ── Sidebar ───────────────────────────────────────────────── */}
            <aside className="w-64 bg-slate-950 border-r border-slate-800 flex flex-col pt-6 pb-4 shrink-0">
                {/* Logo */}
                <div className="px-6 mb-8 mt-2 text-xl font-bold tracking-tight text-white flex gap-2 items-center">
                    <div className="w-8 h-8 rounded bg-red-600 flex items-center justify-center shadow-lg shadow-red-500/20">
                        <HardDrives weight="bold" className="text-lg" />
                    </div>
                ...
                <nav className="flex-1 px-4 space-y-1">
                    ...
                    <SidebarLink href="/admin/users"     icon={Users}       label="Quản lý Users"  active />
                ...
                <div className="px-4 mt-4 border-t border-slate-800 pt-4">
                    <button
                        ...
                        className="w-full flex items-center gap-3 px-4 py-3 rounded-lg text-slate-400 hover:bg-red-500/10 hover:text-red-400 transition-all font-medium"
                    >
            ...
            <main className="flex-1 flex flex-col h-screen overflow-hidden">
                ...
                <header className="h-16 border-b border-slate-800 bg-slate-900/80 backdrop-blur flex justify-between items-center px-8 z-10 sticky top-0 shrink-0">
                    <h1 className="text-xl font-semibold text-white">Quản trị Thành Viên</h1>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex items-center gap-3 cursor-pointer hover:bg-slate-800 p-2 rounded-lg transition">
                            <div className="text-right hidden sm:block">
                                <div className="text-sm font-semibold text-white leading-tight">{user?.fullName ?? 'Admin'}</div>
                                                        ...
                                                        {isActioning ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <button
                                                                    ...
                                                                    title="Đổi quyền hạn"
                                                                    className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-indigo-500/10 text-indigo-400 border border-indigo-500/20 hover:bg-indigo-500/20 rounded-lg text-xs font-medium transition"
                                                                >
                                                                    <UserSwitch weight="bold" className="text-sm" />
                                                                    Đổi quyền
                                                                </button>
