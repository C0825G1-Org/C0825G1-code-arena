import CodeEditor from "../../../components/user/code-editor/CodeEditor";
import ProblemPanel from "../../../components/user/code-editor/ProblemPanel";
import LanguageSelector from "../../../components/user/code-editor/LanguageSelector";
import Split from "react-split";
import SampleTestCases from "../../../components/user/code-editor/SampleTestCases";
import { useEffect, useState } from "react";
import { getSampleTestCases, TestCase } from "../../../services/user/code-editor/problemService";
import { useSettings } from "../../../custom_hooks/user/code-editor/useSettings";
import SettingsPopover from "../../../components/user/code-editor/SettingsPopover";
import { useArena } from "../../../custom_hooks/user/code-editor/useArena";
